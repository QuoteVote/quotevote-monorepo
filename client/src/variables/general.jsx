...
const widgetStories = [
  {
    ...
    body: (
      <p>
        Wifey made the best Father
        '
        s Day meal ever. So thankful so happy so
  ...
  },
  {
    ...
    body: (
      <div>
        ...
        <p>
          What if Kanye made a song about Kanye Royère doesn
          '
          t make a Polar
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        s 92.3 I
        &apos;
        m about to play the first single from
